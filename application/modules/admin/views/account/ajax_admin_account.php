      ...
      <tr>
         <td style="background: #FFF;padding: 5px 5px 5px 5px;" valign="top">
            <table style="width: 100%;">
               <tr>
                  <td>
                     <div class="h-title">Danh sách User</div>
                  </td>
                  <td style="float: right;">
                     <div class="addlink"><a href="<?php echo base_url(); ?>admin/accountadmin/add" class="add grouped_elements"><span>Thêm mới</span></a></div>
                  </td>
               </tr>
            </table>
            <div class="box-content">
               ...
               <form action="<?php echo base_url();?>admin/ctvadmin/deletes" method="post" accept-charset="utf-8" id="admindata_account">
                  ...
                  <table class="admindata">
                     <thead>
                        <tr>
                           <th class="head" colspan="7">
                              <a class="del" onclick="return action_del('admindata_account','account');"><span>Xóa</span></a>                                Có <?php echo count($list_ctv)?> CTV <span class="pages"><span class="pagebar-mainbody">
                           <?php 
                     ...
                     <tfoot>
                        <td colspan="7">
                           <a class="del" onclick="return action_del('admindata_account','account');"><span>Xóa</span></a>                            
