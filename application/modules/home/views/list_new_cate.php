														...
														<div class="cls_box_content_inner">
															<div class="cls_box_content_row cls_first_content">
																<div class="cls-post-listing clearfix">
																	...
																	<?php 
																	if(isset($last_new[0]['content_new']))
																	{
																	...
																	?>
																		<li class="cls-item-no0 cls-row0 cls-item cls-first-in-line clearfix cls-last-in-line cls-only-in-line">
																			<div class="cls-field-image">
																				<div class="cls-item-value"><a href="<?php echo base_url();?>post/<?php echo $last_new[0]['id_new']?>-<?php echo  mb_strtolower(url_title(removesign($last_new[0]['title_new'])))?>" title="<?php echo  $last_new[0]['title_new']?>" title="<?php echo $last_new[0]['title_new']?>">
																				<?php 
